...
SELECT * FROM dates1
WHERE date_as_text = '2020-05-10 10:45:29.000');
...
SELECT * FROM dates1
WHERE date_as_number = '2020-05-10 10:45:29.000');
...
SELECT * FROM dates1
WHERE date_as_text = '2020-05-10 10:45:29';
...
SELECT * FROM dates1
WHERE date_as_number '2020-05-10 10:45:29';
